...
const images = import.meta.glob('@/assets/set/**/*.png', { eager: true });
const imageMap = Object.keys(images).reduce((acc, path) => {
  // 提取相对路径（如 'abds/acb.png'）
  const relativePath = path.replace(/^.*\/set\//, '').replace('.png', '');
  acc[relativePath] = images[path].default; // 存储完整解析路径
  return acc;
}, {});
const school = ref([
  { chartalks: [], cbsrc: imageMap['abds/acb'], logosrc: imageMap['abds/abds'], nameen: 'ABYDOS ACADEMY', namecn: '阿拜多斯', intd: '阿拜多斯曾经面积广阔、人口众多，但随着来源不明的沙尘暴在区域内席卷，<br/>大部分土地都变成了沙漠，居民也逐渐迁出，繁华之地走向荒芜。<br/>现在，阿拜多斯只剩下五名学生注册在案了。', intd2: '阿拜多斯曾经面积广阔、人口众多，但随着来源不明的沙尘暴<br/>在区域内席卷,大部分土地都变成了沙漠，居民也逐渐迁出，<br/>繁华之地走向荒芜。<br/>现在，阿拜多斯只剩下五名学生注册在案了。' },
  { chartalks: [], cbsrc: imageMap['ghn/gcb'], logosrc: imageMap['ghn/ghn'], nameen: 'GEHENNA ACADEMY', namecn: '格黑娜', intd: '基沃托斯三大学院之一，其学生会名为“万魔殿”。<br/>用两个词来概括这里的风气，就是“自由”和“混沌”。每天都有人惹是生<br/>非，让负责维持秩序的风纪委员会非常头疼。当然，拜这些随心所欲、行为出<br/>格的家伙们所赐，格黑娜的风纪委员也锻炼出了强大的实力。<br/>和圣三一的关系相当差，但最近似乎也有少许缓和的倾向。', intd2: '基沃托斯三大学院之一，其学生会名为“万魔殿”。<br/>用两个词来概括这里的风气，就是“自由”和“混沌”。每天都<br/>有人惹是生非，让负责维持秩序的风纪委员会非常头疼。当<br/>然，拜这些随心所欲、行为出格的家伙们所赐，格黑娜的风纪委员也锻炼出了强大的实力。<br/>和圣三一的关系相当差，但最近似乎也有少许缓和的倾向。' },
  { chartalks: [], cbsrc: imageMap['ssy/sscb'], logosrc: imageMap['ssy/ssy'], nameen: 'TRINITY GENERAL ACADEMY', namecn: '圣三一', intd: '基沃托斯三大学院之一，其学生会名为“茶话会”。有自警团、正义实现部、<br/>救护骑士团等许多社团。<br/>总体来说重视纪律和文化，学生们大多诚实善良，给人不谙世事的大小姐印<br/>象，内部的治安状况有序而稳定。<br/>当然，圣三一并不是完美的。在风平浪静的学院氛围下，潜藏着不少问题。<br/>和格黑娜在传统上是敌对关系，不过近期好像提出了新的动议。', intd2: '基沃托斯三大学院之一，其学生会名为“茶话会”。有自警团、<br/>正义实现部、救护骑士团等许多社团。<br/>总体来说重视纪律和文化，学生们大多诚实善良，给人不谙世<br/>事的大小姐印象，内部的治安状况有序而稳定。<br/>当然，圣三一并不是完美的。在风平浪静的学院氛围下，潜藏<br/>着不少问题。<br/>和格黑娜在传统上是敌对关系，不过近期好像提出了新的动<br/>议。' },
  { chartalks: [], cbsrc: imageMap['qx/qcb'], logosrc: imageMap['qx/qx'], nameen: 'MILLENNIUM SCIENCE ACADEMY', namecn: '千禧年', intd: '基沃托斯三大学院之一，全名千禧年科技学院，其学生会名为“研讨会"。<br/>C&amp;C女仆部负责维持秩序，工程部也名声在外。正如名字所示，千禧年最关<br/>注技术，基沃托斯的前沿发明几乎都出自他们之手。<br/>学生以理科生居多，不乏醉心学术对现实生活反而不太关心的怪异天才。', intd2: '基沃托斯三大学院之一，全名千禧年科技学院，其学生会名为<br/>“研讨会"。C&amp;C女仆部负责维持秩序，工程部也名声在外。正<br/>如名字所示，千禧年最关注技术，基沃托斯的前沿发明几乎都<br/>出自他们之手。学生以理科生居多，不乏醉心学术对现实生活<br/>反而不太关心的怪异天才。' },
  { chartalks: [], cbsrc: imageMap['bgyx/bcb'], logosrc: imageMap['bgyx/bgyx'], nameen: 'ALLIED HYAKKIYAKO ACADEMY', namecn: '百鬼夜行', intd: '以和风为特色，旅游业发达，有庆典运营管理部、忍术研究部、修行部、阴阳<br/>部等风格独特的社团。<br/>百鬼夜行联合学院并没有正式的学生会，而是由众多彼此独立的社团、委员会<br/>联合组成的。美食、温泉和庆典，是百鬼夜行的三大关键词。不过也要提防戴<br/>着天狗面具的危险分子出现！', intd2: '以和风为特色，旅游业发达，有庆典运营管理部、忍术研究<br/>部、修行部、阴阳部等风格独特的社团。<br/>百鬼夜行联合学院并没有正式的学生会，而是由众多彼此独立<br/>的社团、委员会联合组成的。<br/>美食、温泉和庆典，是百鬼夜行的三大关键词。不过也要提防<br/>戴着天狗面具的危险分子出现！' },
  { chartalks: [], cbsrc: imageMap['shj/scb'], logosrc: imageMap['shj/shj'], nameen: 'SHANHAIJING ACADEMY', namecn: '山海经', intd: '以中华风为特色的学院，有梅花园、炼丹研究会等社团。与基沃托斯的其它<br/>学院相比，文化十分独特，并且有着悠久的历史传统。<br/>在山海经，美食店铺林立，旅游业也非常兴盛。只是内部的具体情况不太为<br/>外人所知……', intd2: '以中华风为特色的学院，有梅花园、炼丹研究会等社团。<br/>与基沃托斯的其它学院相比，文化十分独特，并且有着悠久的<br/>历史传统。<br/>在山海经，美食店铺林立，旅游业也非常兴盛。<br/>只是内部的具体情况不太为外人所知……' },
]);
const chartalks = ref([
  { name: '绫音', head: imageMap['abds/abds3'], content: '今天有风沙，出门注意安全哦！' },
  { name: '白子', head: imageMap['abds/abds1'], content: '了解了。' },  
  { name: '星野', head: imageMap['abds/abds2'], content: '真适合睡觉啊zzz' },  
  { name: '芹香', head: imageMap['abds/abds5'], content: '欢迎光临——你们怎么来了？' },
  { name: '野宫', head: imageMap['abds/abds4'], content: '我请大家吃拉面☆' },
  { name: '星野', head: imageMap['abds/abds2'], content: '芹香酱，要大碗的哦~' },
]);
const chartalks2 = ref([
  { name: '千夏', head: imageMap['ghn/ghn3'], content: '会长，万魔殿的人有请……' },
  { name: '伊织', head: imageMap['ghn/ghn2'], content: '会长，便利屋又惹事了……' },  
  { name: '日奈', head: imageMap['ghn/ghn1'], content: '知道了，亚子，列为我这周的第118和119件待办事项吧。' },  
  { name: '阿露', head: imageMap['ghn/ghn4'], content: '只要这本《打破规则的108条》大卖，我们便利屋就能声名远扬！' },
  { name: '佳代子', head: imageMap['ghn/ghn5'], content: '社长，到现在销售额还是零哦。' },
  { name: '睦月', head: imageMap['ghn/ghn6'], content: '嘻嘻，阿露酱没有想到，格黑娜的学生在打破规则方面不需要指导呢~' },
]);
const chartalks3 = ref([
  { name: '真白', head: imageMap['ssy/ssy1'], content: '日富美，偷走佩洛洛玩偶的犯人已经抓到了。' },
  { name: '日富美', head: imageMap['ssy/ssy2'], content: '太好了！谢谢各位！' },  
  { name: '真白', head: imageMap['ssy/ssy1'], content: '不幸的是，在部长正义的火力下，佩洛洛也牺牲了……' },  
  { name: '芹娜', head: imageMap['ssy/ssy4'], content: '花江酱，工作适应得怎么样？' },
  { name: '花江', head: imageMap['ssy/ssy3'], content: '非常顺利，前辈！病人们都很友好呢~' },
  { name: '花江', head: imageMap['ssy/ssy3'], content: '不过，为什么一提到打针，大家就都会从我身边溜走呢？~' },
]);
const chartalks4 = ref([
  { name: '桃', head: imageMap['qx/qx1'], content: '小绿快来！我想好新作Boss的设定啦！' },
  { name: '绿', head: imageMap['qx/qx2'], content: '唔……是什么样的呢？' },  
  { name: '桃', head: imageMap['qx/qx1'], content: '哼哼，就叫“大魔王优香”！' },  
  { name: '琴里', head: imageMap['qx/qx3'], content: '这就是……基沃托斯万千学生梦寐以求的……' },
  { name: '响', head: imageMap['qx/qx5'], content: '让人如听仙乐耳暂明的……' },
  { name: '歌原', head: imageMap['qx/qx4'], content: '带有蓝牙功能的手枪！' },
]);
const chartalks5 = ref([
  { name: '静子', head: imageMap['bgyx/bgyx1'], content: '这次的樱花节要办得不同凡响，菲娜有什么建议吗？' },
  { name: '菲娜', head: imageMap['bgyx/bgyx2'], content: '我有一堆想给大家展示的电影捏！就在百夜堂门口播放咩！' },  
  { name: '静子', head: imageMap['bgyx/bgyx1'], content: '已经猜到是什么样的电影了！拒绝！绝对不可以！！' },  
  { name: '枫', head: imageMap['bgyx/bgyx4'], content: '椿前辈好厉害！从中午到晚上一直坐在河畔一动不动地修行！' },
  { name: '枫', head: imageMap['bgyx/bgyx4'], content: '这等定力！不愧是完美的绝世佳人！' },
  { name: '三森', head: imageMap['bgyx/bgyx3'], content: '……椿又睡着了吧？' },
]);
const chartalks6 = ref([
  { name: '纱绫', head:  imageMap['shj/shj1'], content: '鼠鼠……跑到哪儿了呢？' },
  { name: '瞬', head: imageMap['shj/shj2'], content: '呵呵，你要找的，是这孩子吗？' },  
  { name: '纱绫', head: imageMap['shj/shj1'], content: '鼠鼠！快谢谢这位大姐——啊不，是小姐！' },  
  { name: '瞬', head: imageMap['shj/shj2'], content: '心奈酱，我看到你了哦。' },
  { name: '心奈', head: imageMap['shj/shj3'], content: '姐姐……怎么会……我明明这么早就偷偷出门了……' },
  { name: '瞬', head: imageMap['shj/shj2'], content: '呵呵，因为是姐姐嘛～还有，就算躲起来跳\n“壮壮体操”，也不会长高的哦。' },
]); 
